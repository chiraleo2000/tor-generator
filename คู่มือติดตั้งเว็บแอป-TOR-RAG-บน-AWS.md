...
เวอร์ชันแอป **v0.8.1** · Region **`ap-southeast-1` (สิงคโปร์)**  
...
ได้ไฟล์ `documents/exports/tor-pn-aws-dataset-v0.8.1.zip` แตกแล้วตั้งใน `.env` ของเครื่องที่มี AWS CLI:
...
zip ของสกิล: `app/infra/quick/amazon Quick agents/Skills - TOR/tor-agents-skills-v0.8.1.zip`
