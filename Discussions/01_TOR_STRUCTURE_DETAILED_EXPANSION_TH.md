...
> **อัปเดต 9 ก.ย. 2026:** โครงสร้างที่แอปใช้จริงไม่ใช่ชุด 10/13 หมวดตายตัวอีกต่อไป  
> ยึด [37-TOR-PROFILES-BY-TYPE.md](37-TOR-PROFILES-BY-TYPE.md) และ `app/backend/app/domain/section_profile.py`  
> หัวข้อย่อยขอบเขตงานแปรตามหมวดใหญ่ ๗ ประเภท — **ระบบงานปัจจุบันไม่ใช้กับจัดซื้อครุภัณฑ์ / ก่อสร้าง / จ้างเหมาเอกสาร**
