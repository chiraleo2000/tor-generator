...
> **อัปเดต 9 ก.ย. 2026:** แอปที่รันอยู่ใช้พื้นที่ทำงาน **ห้าขั้น** และ **Section_Profile ตามประเภทงาน**  
> อย่าใช้ลำดับส่วนที่ 1–10 ในเอกสารนี้เป็นชุดหัวข้อของระบบ — ดู [37-TOR-PROFILES-BY-TYPE.md](37-TOR-PROFILES-BY-TYPE.md)  
> เวิร์กโฟลว์ในโค้ดปัจจุบันอยู่ที่ [21-WORKFLOW_DRAFT_TOR.md](21-WORKFLOW_DRAFT_TOR.md)
