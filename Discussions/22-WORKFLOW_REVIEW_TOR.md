...
**ตรวจจากโค้ดจริง:** 14 กันยายน 2026 (`app/frontend` + `app/backend` · v0.7.0)  
...
> **v0.6.1:** ขั้นตรวจท้ายดึง RAG กฎหมาย + มาตรฐาน (เกณฑ์กลาง ICT / ISO / OWASP / PDPA ฯลฯ) ตามประเภทงาน · งบ analyze/suggestion สูง · Amazon Quick `tor-review-compliance` sync แล้ว
...
|--------|-----------|-----------|
| เจ้าหน้าที่ | อัปโหลดไฟล์ สกัด ยืนยันตรวจ เทียบไฟล์อื่นได้ | ตรวจร่างโครงการนี้ ถามความเห็น ส่งขออนุมัติเมื่อครบหัวข้อทองตามประเภทงาน |
...
| ประกอบร่างแล้วคะแนน 0 | แก้แล้ว — รวมหัวข้อย่อยหมวด ๔ ตามโปรไฟล์และคลาย JSON แม่ |
