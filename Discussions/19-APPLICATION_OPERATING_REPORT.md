...
**เวอร์ชัน 0.8.3** · ค่า LLM/embedding ตาม `.env.example` (Gemma 4 + EmbeddingGemma 768-d + งบ `TOR_*`) · วันที่จัดทำ **24 สิงหาคม 2026** · อัปเดตคู่มือ AWS Quick **14 กันยายน 2026** · ผลทดสอบล่าสุด **18 กันยายน 2026** (unfreeze ทุกผู้ให้บริการ · Vitest 336 · pytest 2172 · Gemini ถาม-ตอบไม่ค้าง · ร่าง 16/16)  
