    ...
    <div data-testid="help-page" className="max-w-4xl">
      <div className="mb-2">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          คำอธิบายและภาพประกอบแต่ละส่วนของระบบ — สรุปจาก discussions/13–30 (v0.3.0)
        </p>
      </div>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>เนื้อหาตาม Section_Profile ของประเภทงาน พร้อมส่งตรวจ</td>
          </tr>
          <tr>
            <td>ตรวจสอบ TOR</td>
  ...
  return (
    <GuideBlock title="ถาม-ตอบ">
      <p>
        ...
        ของ Gemma แล้วตอบเป็นโครงอ่านง่าย (สรุป คำตอบ ตารางหลักที่เกี่ยวข้อง ข้อควรระวัง) พร้อมชิปและบัตรแหล่งข้อมูล
        ให้ครอบคลุมเงื่อนไขและข้อยกเว้น — ไม่ใช่โครงบันทึก 6 หัวข้อ
      </p>
      <ol>
...
function ReviewTab() {
  return (
    <GuideBlock title="ตรวจสอบ TOR">
      ...
      <ol>
        <li>
          <strong>ในโครงการขั้นที่ ๔</strong> — แชทรีวิว + ตรวจด้วยกฎอัตโนมัติเมื่อเข้าขั้น (คะแนน ≥ 70 เป็นโทนผ่านบนจอ ไม่ล็อกส่งตรวจ) + ข้อค้นพบสองกลุ่ม + ข้อเสนอแนะจากการทบทวน
        </li>
        <li>
          <strong>
            หน้า <code>/review</code>
          </strong>{" "}
          — ตรวจไฟล์ TOR ภายนอก โดยไม่ต้องสร้างโครงการ · สามขั้น: เลือกไฟล์ → สกัดข้อความ → ยืนยันเริ่มตรวจสอบ · ใช้กฎ + RAG + เอไอชุดเดียวกับขั้นที่ ๔ · ผลแยกกลุ่ม ก (ผิดกฎหมาย/ระเบียบ) กับกลุ่ม ข (ความเสี่ยง)
        </li>
      </ol>
      <p>
