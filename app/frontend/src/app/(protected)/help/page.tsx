    ...
    <div data-testid="help-page" className="max-w-4xl">
      <div className="mb-2">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          คำอธิบายและภาพประกอบแต่ละส่วนของระบบ — สรุปจาก discussions/13–19 (v0.2.3)
        </p>
      </div>
...
function OverviewTab() {
  return (
    <GuideBlock title="ภาพรวมระบบ">
      ...
      <p>
        เส้นทางหลักบนหน้าจอคือ<strong>พื้นที่ทำงาน 5 Phase</strong> (ไม่ใช่วิซาร์ด 8 ขั้น) แยกจากเมนู{" "}
        <strong>ถาม-ตอบ</strong> (คลังความรู้) และ <strong>ตรวจสอบ TOR</strong> (ไฟล์ภายนอก)
      </p>
      <Flow steps={["เข้าสู่ระบบ", "แดชบอร์ด", "ร่าง 5 Phase", "ถาม-ตอบ", "ตรวจสอบ"]} />
      ...
      <Figure src="/help/19-diagram-phases.png" alt="5 Phase" caption="พื้นที่ทำงาน 5 Phase — เส้นทางหลักบน UI" />
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>ร่าง 5 Phase, ถาม-ตอบ, ส่งออก, ตรวจไฟล์ภายนอก</td>
          </tr>
          <tr>
            <td>ผู้ตรวจสอบ</td>
            <td>
  ...
  return (
    <GuideBlock title="ผู้ดูแลระบบ">
      ...
      <ul className="list-disc space-y-1 pl-5">
        ...
        <li>
          ค่าเริ่มต้น: LM Studio <code>google/gemma-4-e4b</code> + EmbeddingGemma · timeout 180s · pgvector
        </li>
        <li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>ครบ 13 หมวด + ยืนยัน HITL ทั้ง 5 หมวด</td>
          </tr>
          <tr>
