  ...
  return (
    <GuideBlock title="กระบวนการร่างห้าขั้น">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>ดูตารางผลวิเคราะห์ (ระบบดึงมาตรฐานกลางเข้าช่องที่ไม่ใช่ข้อเท็จจริงแล้วตอนวิเคราะห์) แล้วกดไปขั้นที่ ๒</td>
      ...
      <ol>
        ...
        <li>
          ขั้นที่ ๑: ดูตารางความครบ (ช่องกฎหมาย/มาตรฐานถูกเติมจากคลังตอนวิเคราะห์แล้วถ้ามี) แล้วกด{" "}
  ...
  return (
    <GuideBlock title="ถาม-ตอบ">
      <p>
        ...
        คนละประวัติกับแชทร่าง Phase 2 ระบบดึงชิ้นข้อความจาก pgvector หลายสิบชิ้นภายในหน้าต่าง 100K
...
function ReviewTab() {
  return (
    <GuideBlock title="ตรวจสอบ TOR">
      ...
      <ol>
        <li>
          <strong>ในโครงการขั้นที่ ๔</strong> — แชทรีวิว + ตรวจด้วยกฎอัตโนมัติเมื่อเข้าขั้น (ผ่านเมื่อคะแนน ≥ 70) + ข้อเสนอแนะจากการทบทวน
        </li>
        <li>
          <strong>
