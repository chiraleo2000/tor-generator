...
SCOPE_HINTS: dict[str, str] = {
    ...
    Scope.FUNCTIONAL: (
        "เจ้าของขอบเขตและวิธีการดำเนินงาน ข้อกำหนดทั่วไป การบันทึก การประมวลผล "
        "การให้บริการ และแบ็กเอนด์ — เขียนเป็นข้อย่อยโดยไม่มีเลขหมวดนำหน้า "
        "ห้ามใส่แผนทดสอบยาว"
    ),
    Scope.INTEGRATION: "ระบบปลายทางที่ต้องเชื่อมโยง รูปแบบการเชื่อมโยงผ่านส่วนต่อประสานโปรแกรม และขอบเขตการโอนย้ายข้อมูลเดิม",
    Scope.LICENSES: (
        "ตารางครุภัณฑ์/ลิขสิทธิ์ซอฟต์แวร์เท่านั้น คอลัมน์: ลำดับ รายการ จำนวนสิทธิ์ "
        "ราคาต่อหน่วย ราคารวม ใช้เกณฑ์กลาง ICT (ใช้/ไม่ใช้) เหตุผลถ้าไม่ใช้ — "
        "ห้ามซ้ำหัวตาราง ห้ามพิมพ์ [Table N] ห้ามแยกคอลัมน์ใช้|ไม่ใช้"
    ),
    ...
    Scope.TESTING: (
        "เฉพาะแผนและประเภทการทดสอบ (หน้าที่ การเชื่อมโยง ประสิทธิภาพ ความมั่นคง "
        "การยอมรับโดยผู้ใช้) พร้อมเกณฑ์ผ่าน/หลักฐาน — "
        "ห้ามคัดลอกขอบเขตและวิธีการดำเนินงาน ข้อกำหนดทั่วไป หรือฟังก์ชันระบบ "
        "ห้ามใส่เลข ๘.๑/8.1"
    ),
