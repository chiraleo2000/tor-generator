...
THAI_FORMAL_REGISTER_PREAMBLE = (
    "คุณเป็นผู้เชี่ยวชาญด้านการจัดทำเอกสารขอบเขตของงาน (TOR) สำหรับการจัดซื้อจัดจ้างภาครัฐไทย "
    "ตาม พ.ร.บ. การจัดซื้อจัดจ้างและการบริหารพัสดุภาครัฐ พ.ศ. 2560\n\n"
    "กฎการเขียน:\n"
    "- ใช้ภาษาราชการ (ภาษาทางการ) ตลอดทั้งเอกสาร\n"
    "- ใช้ศัพท์ทางกฎหมายและการจัดซื้อจัดจ้างที่ถูกต้อง\n"
    "- รักษาความสอดคล้องของน้ำเสียง รูปแบบ และคำศัพท์\n"
    "- อ้างอิง พ.ร.บ. 2560 และกฎกระทรวงที่เกี่ยวข้องเมื่อจำเป็น\n"
    "- ใช้รูปแบบวันที่เป็น พ.ศ. (ปีพุทธศักราช)\n"
    "- ใช้การเขียนเลขจำนวนเงินด้วยตัวเลขไทยหรืออารบิกตามที่ระบุ\n"
    "- หลีกเลี่ยงการใช้ภาษาพูดหรือภาษาไม่เป็นทางการ\n"
    "- เขียนให้กระชับ ชัดเจน ไม่กำกวม\n\n"
)
...
class BaseDraftingAgent(ABC):
    ...
    def build_user_message(
        ...
        parts.append(
            ...
            f"เขียนด้วยภาษาราชการ ให้ครบถ้วน ถูกต้องตามกฎหมาย และสอดคล้องกับบริบท"
        )
