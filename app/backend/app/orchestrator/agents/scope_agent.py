...
class ScopeDraftingAgent(BaseDraftingAgent):
    ...
    def get_system_prompt(self, category: str | None = None) -> str:
        ...
        return (
            ...
            "- ห้ามพิมพ์เลขหมวด/ข้อย่อยนำหน้า (๘.๑ 8.1.2) และห้ามพิมพ์ [Table N]\n"
            "- หัวข้อการทดสอบมีเฉพาะแผน/เกณฑ์ทดสอบ — ห้ามยกขอบเขตและวิธีการดำเนินงานมาวาง\n"
            "- หัวข้อครุภัณฑ์/ลิขสิทธิ์ใช้ตารางเกณฑ์กลาง ICT คอลัมน์เดียวชุด ห้ามซ้ำหัวตาราง\n"
            "- ถ้ามีร่างปัจจุบันในหัวข้อย่อย ให้คงสาระที่ผู้ใช้แก้แล้ว "
            "และเติมเฉพาะส่วนที่ยังว่างหรือยังไม่ครบจากเอกสารขั้นที่ ๐\n"
        )
