...
เวอร์ชันแพ็กเกจ **v0.8.1** · Region แนะนำ **`ap-southeast-1`**  
...
แพ็กเกจ zip: [`amazon Quick agents/Skills - TOR/tor-agents-skills-v0.8.1.zip`](amazon%20Quick%20agents/Skills%20-%20TOR/tor-agents-skills-v0.8.1.zip)  
...
1. แตก `tor-agents-skills-v0.8.1.zip`
