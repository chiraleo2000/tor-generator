...
description: ตรวจสอบ TOR ทั้งฉบับแบบลึกด้วย checklist กฎกำหนดได้ + RAG กฎหมายและมาตรฐานหลายคำค้น ตาม /review และ Phase 4 ของแอป v0.7.1 ให้คะแนนคุณภาพ ข้อค้นพบกลุ่ม ก/ข และข้อเสนอแนะ. ใช้เมื่อตรวจไฟล์ TOR หรือทบทวนร่างครบหมวด.
