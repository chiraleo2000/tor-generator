...
แพ็กเกจนี้สะท้อนกระบวนการของแอป TOR **v0.8.3** (5 ขั้นร่าง + ตรวจสอบลึกด้วยกฎหมายและมาตรฐาน) ให้รันบน **Amazon Quick** (workplace AI) โดยเรียกคลังความรู้ผ่าน MCP connector ที่มีอยู่แล้ว — **ไม่ใช่ QuickSight**
...
แพ็กเกจ zip พร้อมแจก: [`../amazon Quick agents/Skills - TOR/`](../amazon%20Quick%20agents/Skills%20-%20TOR/) (สร้างจากโฟลเดอร์ `agents-skills` รุ่น **v0.8.3**)  
...
- FACT_REQUIRED: `s1,s2,s5,s6` + หัวข้อย่อยขอบเขตบังคับข้อแรกของประเภทงาน
...
- หัวข้อย่อยขอบเขต: ownership-safe · ลำดับ `1./1.1` · licenses = ตาราง ICT · testing ≠ วิธีการดำเนินงาน
- ตรวจท้าย: retrieve กฎหมายแล้วตามด้วยมาตรฐาน (ICT/ISO/OWASP/PDPA) ตามประเภทงาน
